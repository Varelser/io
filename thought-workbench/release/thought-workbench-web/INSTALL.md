...
- 別のパスで配る場合は [vite.config.ts](/Users/s_seq/Downloads/thought-workbench/vite.config.ts) の `base`、manifest の `start_url / scope` を合わせて変更してください
...
3. `main` へ push する
4. [deploy.yml](/Users/s_seq/Downloads/thought-workbench/.github/workflows/deploy.yml) が成功することを確認する
...
- 使い方の全体像は [README.md](/Users/s_seq/Downloads/thought-workbench/README.md) を参照してください
